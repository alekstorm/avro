...
package org.apache.avro.scala.test.generated {
   object RecordWithAllTypes$Record {
      ...
      type Descriptor = (null_field.type, (Unit)) ::
    ...
    object RecordWithAllTypes {
      implicit def presenter: _root_.org.apache.avro.scala.generated.PresenterAux[RecordWithAllTypes, _root_.org.apache.avro.scala.RecordThing[RecordWithAllTypes$Record.Descriptor]] = new _root_.org.apache.avro.scala.generated.Presenter[RecordWithAllTypes] {
        type R = _root_.org.apache.avro.scala.RecordThing[RecordWithAllTypes$Record.Descriptor]
        override def to(repr: RecordWithAllTypes): R = new _root_.org.apache.avro.scala.RecordThing[RecordWithAllTypes$Record.Descriptor]((RecordWithAllTypes$Record.null_field, ({ repr.null_field; () })) ::
       ...
       _root_.shapeless.HNil)
        ...
        override def from(record: R): RecordWithAllTypes = RecordWithAllTypes({ record.instance.get(RecordWithAllTypes$Record.null_field); () }, record.instance.get(RecordWithAllTypes$Record.boolean_field), record.instance.get(RecordWithAllTypes$Record.int_field), record.instance.get(RecordWithAllTypes$Record.long_field), record.instance.get(RecordWithAllTypes$Record.float_field), record.instance.get(RecordWithAllTypes$Record.double_field), record.instance.get(RecordWithAllTypes$Record.string_field), record.instance.get(RecordWithAllTypes$Record.bytes_field), record.instance.get(RecordWithAllTypes$Record.fixed_field), record.instance.get(RecordWithAllTypes$Record.int_array_field).map(elem => elem), record.instance.get(RecordWithAllTypes$Record.int_map_field).mapValues(value => value), record.instance.get(RecordWithAllTypes$Record.int_array_array_field).map(elem => elem.map(elem => elem)), record.instance.get(RecordWithAllTypes$Record.int_map_map_field).mapValues(value => value.mapValues(value => value)))
      }
    
      def encode[C$ <: _root_.org.apache.avro.scala.Codec[C$] : ({ type L[X <: _root_.org.apache.avro.scala.Codec[C$]] = _root_.org.apache.avro.scala.ValueCodec[X, _root_.org.apache.avro.scala.RecordThing[RecordWithAllTypes$Record.Descriptor]] })#L](repr: RecordWithAllTypes): Iterator[Byte] = {
        implicitly[_root_.org.apache.avro.scala.ValueCodec[C$, _root_.org.apache.avro.scala.RecordThing[RecordWithAllTypes$Record.Descriptor]]].encode(presenter.to(repr))
      }
    
      def decode[C$ <: _root_.org.apache.avro.scala.Codec[C$] : ({ type L[X <: _root_.org.apache.avro.scala.Codec[C$]] = _root_.org.apache.avro.scala.ValueCodec[X, _root_.org.apache.avro.scala.RecordThing[RecordWithAllTypes$Record.Descriptor]] })#L](record: Iterator[Byte]): RecordWithAllTypes = {
        presenter.from(implicitly[_root_.org.apache.avro.scala.ValueCodec[C$, _root_.org.apache.avro.scala.RecordThing[RecordWithAllTypes$Record.Descriptor]]].decode(record))
      }
    }
 }
