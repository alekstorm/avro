...
package org.apache.avro.scala.test.generated {
   object RecordDefaultField$Record {
    ...
    object RecordDefaultField {
      implicit def presenter: _root_.org.apache.avro.scala.generated.PresenterAux[RecordDefaultField, _root_.org.apache.avro.scala.RecordThing[RecordDefaultField$Record.Descriptor]] = new _root_.org.apache.avro.scala.generated.Presenter[RecordDefaultField] {
        type R = _root_.org.apache.avro.scala.RecordThing[RecordDefaultField$Record.Descriptor]
        override def to(repr: RecordDefaultField): R = new _root_.org.apache.avro.scala.RecordThing[RecordDefaultField$Record.Descriptor]((RecordDefaultField$Record.a, (repr.a)) ::
       _root_.shapeless.HNil)
    
        override def from(record: R): RecordDefaultField = RecordDefaultField(record.instance.get(RecordDefaultField$Record.a))
      }
    
      def encode[C$ <: _root_.org.apache.avro.scala.Codec[C$] : ({ type L[X <: _root_.org.apache.avro.scala.Codec[C$]] = _root_.org.apache.avro.scala.ValueCodec[X, _root_.org.apache.avro.scala.RecordThing[RecordDefaultField$Record.Descriptor]] })#L](repr: RecordDefaultField): Iterator[Byte] = {
        implicitly[_root_.org.apache.avro.scala.ValueCodec[C$, _root_.org.apache.avro.scala.RecordThing[RecordDefaultField$Record.Descriptor]]].encode(presenter.to(repr))
      }
    
      def decode[C$ <: _root_.org.apache.avro.scala.Codec[C$] : ({ type L[X <: _root_.org.apache.avro.scala.Codec[C$]] = _root_.org.apache.avro.scala.ValueCodec[X, _root_.org.apache.avro.scala.RecordThing[RecordDefaultField$Record.Descriptor]] })#L](record: Iterator[Byte]): RecordDefaultField = {
        presenter.from(implicitly[_root_.org.apache.avro.scala.ValueCodec[C$, _root_.org.apache.avro.scala.RecordThing[RecordDefaultField$Record.Descriptor]]].decode(record))
      }
    }
 }
 ...
 package org.apache.avro.scala.test.generated {
   object RecordWithDefaults$Record {
    ...
    object RecordWithDefaults {
      implicit def presenter: _root_.org.apache.avro.scala.generated.PresenterAux[RecordWithDefaults, _root_.org.apache.avro.scala.RecordThing[RecordWithDefaults$Record.Descriptor]] = new _root_.org.apache.avro.scala.generated.Presenter[RecordWithDefaults] {
        type R = _root_.org.apache.avro.scala.RecordThing[RecordWithDefaults$Record.Descriptor]
        override def to(repr: RecordWithDefaults): R = new _root_.org.apache.avro.scala.RecordThing[RecordWithDefaults$Record.Descriptor]((RecordWithDefaults$Record.string_field, (repr.string_field)) ::
       ...
       _root_.shapeless.HNil)
        ...
        override def from(record: R): RecordWithDefaults = RecordWithDefaults(record.instance.get(RecordWithDefaults$Record.string_field), record.instance.get(RecordWithDefaults$Record.map_field_empty_default).mapValues(value => value), record.instance.get(RecordWithDefaults$Record.map_field_nonempty_default).mapValues(value => value), record.instance.get(RecordWithDefaults$Record.array_field_empty_default).map(elem => elem))
      }
    
      def encode[C$ <: _root_.org.apache.avro.scala.Codec[C$] : ({ type L[X <: _root_.org.apache.avro.scala.Codec[C$]] = _root_.org.apache.avro.scala.ValueCodec[X, _root_.org.apache.avro.scala.RecordThing[RecordWithDefaults$Record.Descriptor]] })#L](repr: RecordWithDefaults): Iterator[Byte] = {
        implicitly[_root_.org.apache.avro.scala.ValueCodec[C$, _root_.org.apache.avro.scala.RecordThing[RecordWithDefaults$Record.Descriptor]]].encode(presenter.to(repr))
      }
    
      def decode[C$ <: _root_.org.apache.avro.scala.Codec[C$] : ({ type L[X <: _root_.org.apache.avro.scala.Codec[C$]] = _root_.org.apache.avro.scala.ValueCodec[X, _root_.org.apache.avro.scala.RecordThing[RecordWithDefaults$Record.Descriptor]] })#L](record: Iterator[Byte]): RecordWithDefaults = {
        presenter.from(implicitly[_root_.org.apache.avro.scala.ValueCodec[C$, _root_.org.apache.avro.scala.RecordThing[RecordWithDefaults$Record.Descriptor]]].decode(record))
      }
    }
 }
