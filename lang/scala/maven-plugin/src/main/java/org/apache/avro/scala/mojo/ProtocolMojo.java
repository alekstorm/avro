...
import org.apache.avro.scala.CompilerApp;
...
public class ProtocolMojo extends AbstractAvroMojo {
  ...
  protected void doCompile(String filename, File sourceDirectory, File outputDirectory) throws IOException {
    // TODO(alek): support imports, like Java
    CompilerApp.compileAndWrite(outputDirectory, new File(sourceDirectory, filename), CompilerApp.ProtocolInput$.MODULE$);
  }
